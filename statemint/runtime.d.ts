...
export interface RuntimeApis extends GenericRuntimeApis {
  ...
  authorizedAliasersApi: {
    ...
    authorizedAliasers: GenericRuntimeApiMethod<
      (
        ...
        Result<
          Array<XcmRuntimeApisAuthorizedAliasesOriginAliaser>,
          XcmRuntimeApisAuthorizedAliasesError
        >
      >
    >;
  ...
  getParachainInfo: {
    ...
    parachainId: GenericRuntimeApiMethod<
      () => Promise<PolkadotParachainPrimitivesPrimitivesId>
    >;
  ...
  nominationPoolsApi: {
    ...
    pendingRewards: GenericRuntimeApiMethod<
      (who: AccountId32Like) => Promise<bigint>
    >;
    ...
    pointsToBalance: GenericRuntimeApiMethod<
      (poolId: number, points: bigint) => Promise<bigint>
    >;
    ...
    balanceToPoints: GenericRuntimeApiMethod<
      (poolId: number, newFunds: bigint) => Promise<bigint>
    >;
    ...
    memberPendingSlash: GenericRuntimeApiMethod<
      (member: AccountId32Like) => Promise<bigint>
    >;
    ...
    memberNeedsDelegateMigration: GenericRuntimeApiMethod<
      (member: AccountId32Like) => Promise<boolean>
    >;
    ...
    poolAccounts: GenericRuntimeApiMethod<
      (poolId: number) => Promise<[AccountId32, AccountId32]>
    >;
  ...
  stakingApi: {
    ...
    erasStakersPageCount: GenericRuntimeApiMethod<
      (era: number, account: AccountId32Like) => Promise<number>
    >;
     ...
     **/
    pendingRewards: GenericRuntimeApiMethod<
      (era: number, account: AccountId32Like) => Promise<boolean>
    >;
  ...
  reviveApi: {
    ...
    ethBlock: GenericRuntimeApiMethod<
      () => Promise<PalletReviveEvmApiRpcTypesGenBlock>
    >;
    ...
    ethBlockHash: GenericRuntimeApiMethod<
      (number: U256) => Promise<H256 | undefined>
    >;
    ...
    ethReceiptData: GenericRuntimeApiMethod<
      () => Promise<Array<PalletReviveEvmBlockHashReceiptGasInfo>>
    >;
    ...
    uploadCode: GenericRuntimeApiMethod<
      (
        ...
        Result<PalletRevivePrimitivesCodeUploadReturnValue, DispatchError>
      >
    >;
    ...
    getStorage: GenericRuntimeApiMethod<
      (
        ...
        Result<Bytes | undefined, PalletRevivePrimitivesContractAccessError>
      >
    >;
    ...
    address: GenericRuntimeApiMethod<
      (accountId: AccountId32Like) => Promise<H160>
    >;
    ...
    newBalanceWithDust: GenericRuntimeApiMethod<
      (
        ...
        Result<[bigint, number], PalletRevivePrimitivesBalanceConversionError>
      >
    >;
