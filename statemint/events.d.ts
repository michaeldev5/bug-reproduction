...
export interface ChainEvents extends GenericChainEvents {
  ...
  system: {
    ...
    TaskStarted: GenericPalletEvent<
      "System",
      "TaskStarted",
      { task: AssetHubPolkadotRuntimeRuntimeTask }
    >;
  ...
  foreignAssets: {
    ...
    Frozen: GenericPalletEvent<
      "ForeignAssets",
      "Frozen",
      { assetId: StagingXcmV5Location; who: AccountId32 }
    >;
  ...
  bounties: {
    ...
    BountyAwarded: GenericPalletEvent<
      "Bounties",
      "BountyAwarded",
      { index: number; beneficiary: AccountId32 }
    >;
    ...
    CuratorProposed: GenericPalletEvent<
      "Bounties",
      "CuratorProposed",
      { bountyId: number; curator: AccountId32 }
    >;
  ...
  staking: {
    ...
    SlashCancelled: GenericPalletEvent<
      "Staking",
      "SlashCancelled",
      { slashEra: number; validator: AccountId32 }
    >;
  ...
  ahOps: {
     ...
     **/
    FailedToBond: GenericPalletEvent<
      "AhOps",
      "FailedToBond",
      { account: AccountId32; amount: bigint }
    >;
