...
> extends GenericChainTx<TxCall<ChainKnownTypes>> {
  ...
  parameters: {
    ...
    setParameter: GenericTxCall<
      (
        keyValue: AssetHubPolkadotRuntimeRuntimeParameters,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "Parameters";
          palletCall: {
  ...
  stakingRcClient: {
    ...
    relayNewOffencePaged: GenericTxCall<
      (
        offences: Array<[number, PalletStakingAsyncRcClientOffence]>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "StakingRcClient";
          palletCall: {
      ...
      ) => ChainSubmittableExtrinsic<
        {
          ...
          palletCall: {
            ...
            params: {
              ...
              maybeTotal: bigint | undefined;
              maybeUnlocking:
                | Array<PalletStakingAsyncLedgerUnlockChunk>
                | undefined;
            };
          };
        },
  ...
  ahMigrator: {
    ...
    receiveAccounts: GenericTxCall<
      (
        accounts: Array<PalletRcMigratorAccountsAccount>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveMultisigs: GenericTxCall<
      (
        accounts: Array<PalletRcMigratorMultisigRcMultisig>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveProxyProxies: GenericTxCall<
      (
        proxies: Array<PalletRcMigratorProxyRcProxy>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receivePreimageChunks: GenericTxCall<
      (
        chunks: Array<PalletRcMigratorPreimageChunksRcPreimageChunk>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveVestingSchedules: GenericTxCall<
      (
        schedules: Array<PalletRcMigratorVestingRcVestingSchedule>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveReferendaValues: GenericTxCall<
      (
        values: Array<PalletRcMigratorReferendaReferendaMessage>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveReferendums: GenericTxCall<
      (
        referendums: Array<[number, PalletReferendaReferendumInfo]>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveClaims: GenericTxCall<
      (
        messages: Array<PalletRcMigratorClaimsRcClaimsMessage>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveSchedulerMessages: GenericTxCall<
      (
        messages: Array<PalletRcMigratorSchedulerRcSchedulerMessage>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveIndices: GenericTxCall<
      (
        indices: Array<PalletRcMigratorIndicesRcIndicesIndex>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveBountiesMessages: GenericTxCall<
      (
        messages: Array<PalletRcMigratorBountiesRcBountiesMessage>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
    ...
    receiveCrowdloanMessages: GenericTxCall<
      (
        messages: Array<PalletRcMigratorCrowdloanRcCrowdloanMessage>,
      ) => ChainSubmittableExtrinsic<
        {
          pallet: "AhMigrator";
          palletCall: {
